...
После запуска проекта документация доступна в следующих форматах:
  - ReDoc: http://localhost:80/redoc/ — подробное описание эндпоинтов.
  - Swagger: http://localhost:80/swagger/ — песочница для тестирования запросов.  
...
## <p align="center">📋 Примеры запросов (Postman)  </p>
 <p align="center">Коллекция Postman приложена к проекту в файле referral_system.json.</p>
